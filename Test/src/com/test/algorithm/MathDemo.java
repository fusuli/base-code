...
public class MathDemo {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1.abs绝对值函数 对各种数据类型求绝对值
		 */
		System.out.println(Math.abs(-10));// 输出10

		/*
		 * 2.三角函数与反三角函数 cos求余弦 sin求正弦 tan求正切 acos求反余弦 asin求反正弦 atan求反正切
		...
		/*
		 * 4.最值 max(a,b)求最大值 min(a,b)求最小值
		 */
		System.out.println(Math.max(1, 2));// 输出2
		System.out.println(Math.min(1.9, -0.2));// 输出-0.2
		/*
		 * 5.对数 log(a) a的自然对数(底数是e) log10(a) a 的底数为10的对数 log1p(a) a+1的自然对数
